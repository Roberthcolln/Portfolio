        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            <li align="center" class="well" style="">
              <a href="{{ url('/') }}" class="btn btn-sm btn-dark form-control mb-1" target="_blank"><span class="glyphicon glyphicon-lock"></span> Website</a>
          ...
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item">
              ...
              <ul class="nav nav-treeview">
                ...
                <li class="nav-item">
                  <a href="{{ route('kategori_education.index') }}" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
            ...
            <li class="nav-item">
              <a href="{{ route('form_pertanyaan.index') }}" class="nav-link">
                <h5><span class="badge badge-success"> Feedback <i class="fas fa-question"></i></span></h5>
              </a>
            </li>
          </ul>
        </nav>
